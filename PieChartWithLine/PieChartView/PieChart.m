...
//            }
            ...
            finallPrecent = finallPrecent + percent;
            ...
            //把点加入到路径里面
//            CGFloat x2 = radius*cosf(percent *360);
//            CGFloat y2 = radius*sinf(percent *360);
//            CGPoint ll;
////            if (x2 >= 0 && y2 >= 0) {
////                 ll = CGPointMake(center.x+x2, center.y-y2);
////            } else if (x2 >= 0 && y2 < 0) {
////                ll = CGPointMake(center.x+x2, center.y+y2);
////            } else if (x2 < 0 && y2 >= 0) {
////                ll = CGPointMake(center.x+x2, center.y-y2);
...
//                ll = CGPointMake(center.x+x2, center.y+y2);
////            }
            float radian = (M_PI/180.0f)*(finallPrecent * 360);
    ...
    centerView.frame = CGRectMake(0, 0, 140, 140);
